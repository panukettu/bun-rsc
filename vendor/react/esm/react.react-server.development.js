	...
	if (typeof fetch === 'function') {
		...
		var cachedFetch = function fetch(resource, options) {
			...
			if (typeof resource === 'string' && !options) {
				...
				if (
					(request.method !== 'GET' && request.method !== 'HEAD') || // $FlowFixMe[prop-missing]: keepalive is real
					request.keepalive
				) {
...
export {
	...
	ReactServerSharedInternals as __SECRET_SERVER_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,
	cache,
	cloneElement,
	createElement,
	createRef,
