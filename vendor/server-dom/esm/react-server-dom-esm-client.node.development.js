...
function resolveClientReference(bundlerConfig, metadata) {
	...
	return {
		specifier: metadata[2]
			? metadata[0]
			: path.relative(import.meta.dir, metadata[3] ?? process.cwd()) + baseURL + metadata[0],
		name: metadata[1],
	};
}
...
function prepareDestinationForModuleImpl(
	moduleLoading, // Chunks are double-indexed [..., idx, filenamex, idy, filenamey, ...]
	mod,
	nonce
) {
...
function createFromReadableStream(stream, moduleRootPath, moduleBaseURL, options) {
	var response = createResponse(
		moduleRootPath,
		moduleBaseURL,
		noServerCall,
...
export { createFromNodeStream, createServerReference, createFromReadableStream };
