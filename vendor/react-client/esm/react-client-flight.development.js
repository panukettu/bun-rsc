...
var resolveClientReference = $$$config.resolveClientReference;
$$$config.resolveServerReference;
var preloadModule = $$$config.preloadModule;
var requireModule = $$$config.requireModule;
var dispatchHint = $$$config.dispatchHint;
var prepareDestinationForModule = $$$config.prepareDestinationForModule;

var createStringDecoder = $$$config.createStringDecoder;
var readPartialStringChunk = $$$config.readPartialStringChunk;
var readFinalStringChunk = $$$config.readFinalStringChunk;
...
function resolveTypedArray(response, id, buffer, lastChunk, constructor, bytesPerElement) {
	...
	var chunk =
		buffer.length === 0 && lastChunk.byteOffset % bytesPerElement === 0 ? lastChunk : mergeBuffer(buffer, lastChunk); // TODO: The transfer protocol of RSC is little-endian. If the client isn't little-endian
...
export { close, createResponse, getRoot, processBinaryChunk, reportGlobalError };
