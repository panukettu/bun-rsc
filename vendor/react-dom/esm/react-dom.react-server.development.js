...
function preload(href, options) {
	{
		...
		if (options == null || typeof options !== 'object') {
			encountered +=
				' The `options` argument encountered was ' + getValueDescriptorExpectingObjectForWarning(options) + '.';
		} else if (typeof options.as !== 'string' || !options.as) {
			encountered +=
				' The `as` option encountered was ' + getValueDescriptorExpectingObjectForWarning(options.as) + '.';
		}
